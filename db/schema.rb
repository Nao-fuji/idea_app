...
ActiveRecord::Schema.define(version: 2021_01_24_054233) do
  ...
  create_table "idea_purchases", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["idea_id"], name: "index_idea_purchases_on_idea_id"
    t.index ["user_id"], name: "index_idea_purchases_on_user_id"
  end
  ...
  create_table "tweet_purchases", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "price", null: false
    t.bigint "user_id", null: false
    t.bigint "tweet_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["tweet_id"], name: "index_tweet_purchases_on_tweet_id"
    t.index ["user_id"], name: "index_tweet_purchases_on_user_id"
  end
  ...
  create_table "tweets", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["recruit_id"], name: "index_tweets_on_recruit_id"
  ...
  add_foreign_key "tweets", "recruits"
